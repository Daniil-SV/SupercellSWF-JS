...
export class MovieClip extends NATIVE_MOVIECLIP {
  readonly instances = new Vector<MovieClip, DisplayObjectInstance>(
    {
      getItem: function (index: number) {
        return assert_item<typeof NATIVE_DISPLAY_OBJECT, DisplayObjectInstance>(
          this["__get_instance__"](index),
  ...
  readonly frames = new Vector<MovieClip, MovieClipFrame>(
    {
      getItem: function (index: number) {
        return assert_item<typeof NATIVE_MOVIECLIP_FRAME, MovieClipFrame>(
          this["__get_frame__"](index),
          MovieClipFrame
        );
      },
  ...
  readonly frameElements = new Vector<MovieClip, MovieClipFrameElement>(
    {
      getItem: function (index: number) {
        return assert_item<
          typeof NATIVE_MOVIECLIP_ELEMENT,
          MovieClipFrameElement
        >(this["__get_element__"](index), MovieClipFrameElement);
      },
