...
namespace scNapi {
    class Matrix2x3: public Napi::ObjectWrap<Matrix2x3>, public ScObject<sc::Matrix2x3>
    {
    public:
        ...
        sc::Matrix2x3* get_parent() override
        {
            return parent;
        };

        void set_parent(sc::Matrix2x3* item) override
        {
            parent = item;
        };
    ...
    private:
        sc::Matrix2x3* parent = nullptr; // Pointer to object that this class is attached to
