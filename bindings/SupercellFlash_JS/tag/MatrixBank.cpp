...
namespace scNapi
{
        ...
        : Napi::ObjectWrap<MatrixBank>(info)
    {
        ...
        matrices = new Vector<sc::Matrix2x3>(&parent->matrices, &Matrix2x3::constructor);
        colorTransforms = new Vector<sc::ColorTransform>(&parent->colorTransforms, &ColorTransform::constructor);
    };
