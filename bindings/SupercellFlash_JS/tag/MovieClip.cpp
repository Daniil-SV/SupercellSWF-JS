...
namespace scNapi
{
    ...
    */
        ...
        : Napi::ObjectWrap<MovieClip>(info)
    {
        ...
        frameElements = new Vector<sc::MovieClipFrameElement>(&parent->frameElements, &MovieClipFrameElement::constructor);
        instances = new Vector<sc::DisplayObjectInstance>(&parent->instances, &DisplayObjectInstance::constructor);
        frames = new Vector<sc::MovieClipFrame>(&parent->frames, &MovieClipFrame::constructor);
    };
