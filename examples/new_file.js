...
const { saveFileFromURL } = require("./utils");
...
async function newFile() {
    ...
    await saveFileFromURL("fish.png", "https://www.pngfind.com/pngs/b/60-602364_fish-png.png")

    //we could use the built-in methods of image-js, but since they are asynchronous, we will do it manually
    let image = PNG.decode(readFileSync("fish.png"));
    ...
    console.log(`Sc file with "fish" export name saved to ${path.dirname(path.resolve(outFile))} and and it took ${hrtime(start)} seconds!`);
}
